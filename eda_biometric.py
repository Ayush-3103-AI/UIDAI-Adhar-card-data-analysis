"""
Comprehensive Exploratory Data Analysis (EDA) for Aadhaar Biometric Data
...
output_dir = Path("visualizations/biometric")
output_dir.mkdir(parents=True, exist_ok=True)

print("=" * 80)
print("COMPREHENSIVE EDA: AADHAAR BIOMETRIC DATA")
print("=" * 80)
...
data_folder = Path("api_data_aadhar_biometric/api_data_aadhar_biometric")
...
if len(numeric_cols) > 1:
    ...
    plt.title('Correlation Heatmap: Biometric Age Groups', fontsize=16, fontweight='bold', pad=20)
    plt.tight_layout()
...
# Save summary to CSV
summary_df.to_csv(output_dir.parent / "biometric_summary_stats.csv", index=False)
print(f"\n  [OK] Summary statistics saved to: {output_dir.parent / 'biometric_summary_stats.csv'}")

print("\n" + "=" * 80)
print("EDA COMPLETE: BIOMETRIC DATA")
print("=" * 80)
